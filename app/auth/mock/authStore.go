...
//
//	mockgen -source=authStore.go -destination=authStore.go
//
...
func (m *Mocknotifier) NotifyNewLogin(ctx context.Context, userID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NotifyNewLogin", ctx, userID)
	ret0, _ := ret[0].(error)
	return ret0
}

// NotifyNewLogin indicates an expected call of NotifyNewLogin.
func (mr *MocknotifierMockRecorder) NotifyNewLogin(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NotifyNewLogin", reflect.TypeOf((*Mocknotifier)(nil).NotifyNewLogin), ctx, userID)
}
